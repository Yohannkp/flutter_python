...
Stream<List<Personne>> readPersonne(Personne Personne)=>FirebaseFirestore.instance.collection('Personne').where('uid',isEqualTo: Personne.uid).snapshots().map((snapshot) => snapshot.docs.map((doc) =>Personne.fromJson(doc.data())).toList());
